//
//  TemplateMethodConceptual.swift
//  TemplateMethod
//
...
extension AbstractProtocol {
    ...
    /// Эти операции уже имеют реализации.
    func baseOperation1() {
        debugPrint("AbstractProtocol says: I am doing the bulk of the work\n")
    }

    func baseOperation2() {
        debugPrint("AbstractProtocol says: But I let subclasses override some operations\n")
    }

    func baseOperation3() {
        debugPrint("AbstractProtocol says: But I am doing the bulk of the work anyway\n")
    }
...
class ConcreteClass1: AbstractProtocol {
    ...
    func requiredOperations1() {
        debugPrint("ConcreteClass1 says: Implemented Operation1\n")
    }

    func requiredOperation2() {
        debugPrint("ConcreteClass1 says: Implemented Operation2\n")
    }

    func hook2() {
        debugPrint("ConcreteClass1 says: Overridden Hook2\n")
    }
}
...
class ConcreteClass2: AbstractProtocol {
    ...
    func requiredOperations1() {
        debugPrint("ConcreteClass2 says: Implemented Operation1\n")
    }

    func requiredOperation2() {
        debugPrint("ConcreteClass2 says: Implemented Operation2\n")
    }

    func hook1() {
        debugPrint("ConcreteClass2 says: Overridden Hook1\n")
    }
}
...
class TemplateMethodConceptual: XCTestCase {
    ...
    func test() {
        debugPrint("Same client code can work with different subclasses:\n")
