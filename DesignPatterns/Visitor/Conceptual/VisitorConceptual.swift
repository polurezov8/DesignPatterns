...
class ConcreteVisitor1: Visitor {
    ...
    func visitConcreteComponentA(element: ConcreteComponentA) {
        debugPrint(element.exclusiveMethodOfConcreteComponentA() + " + ConcreteVisitor1\n")
    }

    func visitConcreteComponentB(element: ConcreteComponentB) {
        debugPrint(element.specialMethodOfConcreteComponentB() + " + ConcreteVisitor1\n")
    }
}
...
class ConcreteVisitor2: Visitor {
    ...
    func visitConcreteComponentA(element: ConcreteComponentA) {
        debugPrint(element.exclusiveMethodOfConcreteComponentA() + " + ConcreteVisitor2\n")
    }

    func visitConcreteComponentB(element: ConcreteComponentB) {
        debugPrint(element.specialMethodOfConcreteComponentB() + " + ConcreteVisitor2\n")
    }
}
...
class VisitorConceptual: XCTestCase {
    ...
    func test() {
        ...
        debugPrint("The client code works with all visitors via the base Visitor interface:\n")
