...
class Composite: Component {
    ...
    fileprivate func add(component: Component) {
        var item = component
        item.parent = self
        children.append(item)
    }

    fileprivate func remove(component: Component) {
        // ...
    }
...
class Client {
    ...
    static fileprivate func someClientCode(component: Component) {
    ...
    static fileprivate func moreComplexClientCode(leftComponent: Component, rightComponent: Component) {
