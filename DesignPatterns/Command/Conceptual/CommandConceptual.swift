...
class Receiver {
    ...
    func doSomethingElse(_ b: String) {
        debugPrint("Receiver: Also working on (" + b + ")\n")
    }
}
...
class Invoker {
    ...
    func doSomethingImportant() {
        ...
        debugPrint("Invoker: Does anybody want something done before I begin?")

        onStart?.execute()

        debugPrint("Invoker: ...doing something really important...")
        debugPrint("Invoker: Does anybody want something done after I finish?")
