...
class Proxy: Subject {
    ...
    private func checkAccess() -> Bool {
        ...
        debugPrint("Proxy: Checking access prior to firing a real request.")

        return true
    }

    private func logAccess() {
        debugPrint("Proxy: Logging the time of request.")
    }
}
...
class ProxyConceptual: XCTestCase {
    ...
    func test() {
        debugPrint("Client: Executing the client code with a real subject:")
