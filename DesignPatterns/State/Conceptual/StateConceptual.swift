...
class Context {
    ...
    func transitionTo(state: State) {
        debugPrint("Context: Transition to " + String(describing: state))
        self.state = state
...
class ConcreteStateA: BaseState {
    ...
    override func handle1() {
        debugPrint("ConcreteStateA handles request1.")
        debugPrint("ConcreteStateA wants to change the state of the context.\n")
        context?.transitionTo(state: ConcreteStateB())
    }

    override func handle2() {
        debugPrint("ConcreteStateA handles request2.\n")
    }
}
...
class ConcreteStateB: BaseState {
    ...
    override func handle1() {
        debugPrint("ConcreteStateB handles request1.\n")
    }

    override func handle2() {
        debugPrint("ConcreteStateB handles request2.")
        debugPrint("ConcreteStateB wants to change the state of the context.\n")
